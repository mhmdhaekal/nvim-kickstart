...
vim.keymap.set("n", "<leader>/", ":FzfLua grep_curbuf<CR>", { desc = "Open FzF lua live grep curbuf" })
vim.keymap.set("n", "<leader>sd", ":FzfLua diagnostics_document<CR>", { desc = "Open FzF lua diagnostics_document" })
vim.keymap.set("n", "<leader>sx", ":FzfLua diagnostics_workspace<CR>", { desc = "Open FzF lua diagnostics_workspace" })
